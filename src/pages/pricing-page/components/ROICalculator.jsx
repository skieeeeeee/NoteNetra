            ...
            <div className="space-y-4">
              <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  <Icon name="TrendingUp" size={20} color="var(--color-green-500)" strokeWidth={2} />
                  <span className="font-semibold text-green-500">Projected Improvements</span>
                </div>
              ...
              <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-green-500">{results?.newCreditScore}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Improvement:</span>
                    <span className="font-medium text-green-500">+{results?.creditScoreImprovement}</span>
                  </div>
                </div>
              </div>
